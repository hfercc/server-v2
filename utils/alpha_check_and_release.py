...
def insert2db(alpha_id, s_type, universe, author, yearly_tvr, yearly_ret, yearly_sharpe):    
    ...
    try:
        ...
        sql = "INSERT INTO `alpha_details` (`alpha_id`, `author`, `type`, `universe`, `submission_date`, `turnover_0`, `turnover_1`, `turnover_2`, `turnover_3`, `turnover_4`, `turnover_5`, `turnover_6`, `turnover_7`, `turnover_8`, `turnover_9`, `return_0`, `return_1`, `return_2`, `return_3`, `return_4`, `return_5`, `return_6`, `return_7`, `return_8`, `return_9`, `sharpe_0`, `sharpe_1`, `sharpe_2`, `sharpe_3`, `sharpe_4`, `sharpe_5`, `sharpe_6`, `sharpe_7`, `sharpe_8`, `sharpe_9`, `updatetime`) VALUES (%s, %s, %s, %s, %s,%s, %s, %s, %s, %s,%s, %s, %s, %s, %s,%s, %s, %s, %s, %s,%s, %s, %s, %s, %s,%s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE `author`=VALUES(`author`),`submission_date`=VALUES(`submission_date`),`turnover_0`=VALUES(`turnover_0`),`turnover_1`=VALUES(`turnover_1`),`turnover_2`=VALUES(`turnover_2`),`turnover_3`=VALUES(`turnover_3`),`turnover_4`=VALUES(`turnover_4`),`turnover_5`=VALUES(`turnover_5`),`turnover_6`=VALUES(`turnover_6`),`turnover_7`=VALUES(`turnover_7`),`turnover_8`=VALUES(`turnover_8`),`turnover_9`=VALUES(`turnover_9`),`return_0`=VALUES(`return_0`),`return_1`=VALUES(`return_1`),`return_2`=VALUES(`return_2`),`return_3`=VALUES(`return_3`),`return_4`=VALUES(`return_4`),`return_5`=VALUES(`return_5`),`return_6`=VALUES(`return_6`),`return_7`=VALUES(`return_7`),`return_8`=VALUES(`return_8`),`return_9`=VALUES(`return_9`),`sharpe_0`=VALUES(`sharpe_0`),`sharpe_1`=VALUES(`sharpe_1`),`sharpe_2`=VALUES(`sharpe_2`),`sharpe_3`=VALUES(`sharpe_3`),`sharpe_4`=VALUES(`sharpe_4`),`sharpe_5`=VALUES(`sharpe_5`),`sharpe_6`=VALUES(`sharpe_6`),`sharpe_7`=VALUES(`sharpe_7`),`sharpe_8`=VALUES(`sharpe_8`),`sharpe_9`=VALUES(`sharpe_9`),`updatetime`=VALUES(`updatetime`)"
...
def copy_config_file_2configs(original_config_path, alpha_id, formula_flag):
    ...
    if formula_flag == False:
        alpha_node.set('path', '/home/data/alpha/lib/{0}.so'.format(alpha_id))
    else:
